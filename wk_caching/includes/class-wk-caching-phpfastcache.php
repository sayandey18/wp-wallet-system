...
if ( ! class_exists( 'WK_Caching_PHPFastCache' ) ) {
	...
	class WK_Caching_PHPFastCache {
		...
		public function set( $cache_key, $cache_value, $cache_group = 'wk', $expiry = 3600 ) {
			...
			WK_Caching::log( "Set PHP FastCache key: $fast_key, cache key: $cache_key, Cache group: $cache_group, Expiry: $expiry" );
		...
		public function get( $cache_key, $cache_group = 'wk' ) {
			...
			WK_Caching::log( "Get PHP Fast Cache key: $fast_key, cache key: $cache_key, Cache group: $cache_group" );
		...
		public function delete( $cache_key, $cache_group = 'wk', $force = false ) {
			...
			WK_Caching::log( "Delete PHP Fast Cache key: $fast_key, cache key: $cache_key, Cache group: $cache_group" );
		...
		protected function get_driver() {
			return apply_filters( '_wkwc_get_fast_cache_driver', 'Files' );
		}
	}
}
